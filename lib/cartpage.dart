              ...
              Column(
                children: [
                  Container(
                    ...
                    color: Colors.white,
                    child:
                    Image(image: AssetImage(CT.griditemimage)),
                  ),
                  // Container(
                  //   width: 120,
                  //   height: 25,
                    ...
                    children: [
                      Container(
                        ...
                        child: TextButton(onPressed: (){
                          Provider.of<FlipProvider>(context,listen: false).decresquantity(CT);
                        },
                      ...
                      Container(
                        ...
                        child: TextButton(onPressed: (){
Provider.of<FlipProvider>(context,listen: false).addquantityfromcart(CT);
                        },
                          child: Text('+',style: TextStyle(color: Colors.black),),),
                      ),
                    ],
          ...
          Row(
            children: [
              GestureDetector(
                onTap: (){
                  Provider.of<FlipProvider>(context,listen: false).removefromcart(CT);
                },
                child: Container(
